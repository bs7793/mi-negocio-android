-- Apply post-release updates that were previously added to an already-applied migration:
-- 1) create_product_with_variants validation hardening for option type/value length
-- 2) get_product_options_catalog RPC + grant
